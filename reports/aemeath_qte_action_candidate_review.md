...
- Trigger classifications: `{'qte_intro': 2}`
- Source damage labels: `{'intro_skill_damage': 2}`
- Damage bonus categories: `{'none_or_unmodeled_intro': 1, 'resonance_skill': 1}`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| aemeath_qte_intro_human | aemeath_qte_intro_human | aemeath | `1.0` | `0.1667` | `3` | `[0.1346, 0.1346, 1.0766]` | `变奏` | `变奏伤害` | `qte_intro` | `intro_skill_damage` | `none_or_unmodeled_intro` | `48.0` | action_ready_review_candidate | false |
| aemeath_qte_intro_mech | aemeath_qte_intro_mech | aemeath_mech | `1.2` | `0.4333` | `2` | `[0.653, 0.9795]` | `共鸣技能` | `变奏伤害` | `qte_intro` | `intro_skill_damage` | `resonance_skill` | `40.0` | action_ready_review_candidate | false |
...
| --- | --- | --- | --- | --- | --- | --- |
| aemeath_qte_intro_human | `变奏` | `变奏伤害` | `qte_intro` | `intro_skill_damage` | `none_or_unmodeled_intro` | `medium` | `QTE/Intro action with an intro-skill source damage label, but no modeled damage bonus category is confirmed for Human QTE yet.` |
| aemeath_qte_intro_mech | `共鸣技能` | `变奏伤害` | `qte_intro` | `intro_skill_damage` | `resonance_skill` | `high` | `Raw skill category is '共鸣技能' while damage type is '变奏伤害'; candidate is triggered as QTE/Intro by source label and damage label. Preserve raw category for review.` |
...
- Damage classification: `{'raw_skill_category': '变奏', 'raw_skill_category_source_column': '技能', 'raw_damage_type': '变奏伤害', 'raw_damage_type_source_column': '被动', 'trigger_classification': 'qte_intro', 'source_damage_label': 'intro_skill_damage', 'raw_source_damage_label': '变奏伤害', 'damage_bonus_category': 'none_or_unmodeled_intro', 'damage_bonus_category_confidence': 'medium', 'damage_bonus_category_reason': 'QTE/Intro action with an intro-skill source damage label, but no modeled damage bonus category is confirmed for Human QTE yet.', 'classification_warnings': []}`
- Parsed multipliers: `[0.1346, 0.1346, 1.0766]`
...
- Action stub preview: `{'id': 'aemeath_qte_intro_human', 'character_id': 'aemeath', 'action_type': 'swap', 'policy_selectable': False, 'review_only': True, 'trigger_classification': 'qte_intro', 'source_damage_label': 'intro_skill_damage', 'damage_bonus_category': 'none_or_unmodeled_intro', 'action_time': 1.0, 'combat_time_cost': 0.1667, 'hits': [{'damage_multiplier': 0.1346}, {'damage_multiplier': 0.1346}, {'damage_multiplier': 1.0766}], 'tags': ['qte', 'intro'], 'notes': ['This is not applied to simulation yet.']}`
...
- Damage classification: `{'raw_skill_category': '共鸣技能', 'raw_skill_category_source_column': '技能', 'raw_damage_type': '变奏伤害', 'raw_damage_type_source_column': '被动', 'trigger_classification': 'qte_intro', 'source_damage_label': 'intro_skill_damage', 'raw_source_damage_label': '变奏伤害', 'damage_bonus_category': 'resonance_skill', 'damage_bonus_category_confidence': 'high', 'damage_bonus_category_reason': 'Triggered as QTE/Intro, but the source skill category is Resonance Skill; future damage bonus application should use resonance_skill.', 'classification_warnings': ["Raw skill category is '共鸣技能' while damage type is '变奏伤害'; candidate is triggered as QTE/Intro by source label and damage label. Preserve raw category for review."]}`
- Parsed multipliers: `[0.653, 0.9795]`
...
- Action stub preview: `{'id': 'aemeath_qte_intro_mech', 'character_id': 'aemeath_mech', 'action_type': 'swap', 'policy_selectable': False, 'review_only': True, 'trigger_classification': 'qte_intro', 'source_damage_label': 'intro_skill_damage', 'damage_bonus_category': 'resonance_skill', 'action_time': 1.2, 'combat_time_cost': 0.4333, 'hits': [{'damage_multiplier': 0.653}, {'damage_multiplier': 0.9795}], 'tags': ['qte', 'intro'], 'notes': ['This is not applied to simulation yet.']}`
