...
SECTION_PAIRS = [
    ...
    ("Forte Circuit", "forte_circuit"),
    ("Rupturous Trail", "rupturous_trail"),
    ("Fusion Trail", "fusion_trail"),
    ("Seraphic Duet Follow-up Damage", "seraphic_duet_followup_damage"),
    ("Stardust Resonance Interaction", "stardust_resonance_interaction"),
    ("Generated Mechanic Damage", "generated_mechanic_damage"),
    ("Source-gated Implementation", "source_gated_implementation"),
    ("Remaining Unresolved Mechanics", "remaining_unresolved_mechanics"),
