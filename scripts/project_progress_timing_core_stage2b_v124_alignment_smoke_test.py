...
def main() -> None:
    ...
    assert stage["candidate_124_smoke_test_count"] == 68
    assert stage["candidate_124_fresh_extraction_command_count"] == 70
    assert stage["authoritative_fresh_extraction_command_count"] == 268
